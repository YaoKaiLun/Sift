...
final class L10nTests: XCTestCase {
    ...
    func testChineseOverride() {
        ...
        XCTAssertEqual(L10n.stashes, "stashes")
        XCTAssertEqual(L10n.applyStash, "应用")
        XCTAssertEqual(L10n.deleteWorktree, "删除工作树")
        XCTAssertEqual(L10n.cannotApplyStashWithLocalChanges, "当前工作区有未提交改动，无法应用 stash。")
    ...
    func testEnglishOverride() {
        ...
        XCTAssertEqual(L10n.stashes, "stashes")
        XCTAssertEqual(L10n.applyStash, "Apply")
        XCTAssertEqual(L10n.deleteWorktree, "Delete Worktree")
        XCTAssertEqual(L10n.cannotApplyStashWithLocalChanges,
